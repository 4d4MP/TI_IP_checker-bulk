diff --git a/multi_day_ui.py b/multi_day_ui.py
new file mode 100644
index 0000000000000000000000000000000000000000..213a3bd80b1327e2168d0206d5617ea7d2568da8
--- /dev/null
+++ b/multi_day_ui.py
@@ -0,0 +1,567 @@
+"""Multi-day AbuseIPDB bulk checker UI built with ttkbootstrap."""
+
